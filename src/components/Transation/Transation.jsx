...
function Transation({ mainText, subText }) {
  return (
    <div
      className="flex flex-col text-center sm:text-left sm:flex-row h-auto sm:h-60 w-full bg-primary p-10 text-white items-center justify-evenly sm:justify-between"
      data-testid="transation-container"
    >
