        ...
        <div className="mx-6 pt-5 text-center md:text-left">
          <div className="grid grid-1 md:grid-cols-3 lg:grid-cols-3 gap-12">
            <div className="">
              ...
              <p className="text-white mb-5">hello@bursapediary.com</p>
              <p className="text-white">
                But Brooke Chaffin and Catherine Connors are looking to change
                that with the introduction of Maverick.
              </p>

              <div className="flex justify-center mt-5">
                <a href="http://bursapediary.com/" className="mr-9 text-white">
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fab"
                ...
                <a href="http://bursapediary.com/" className="mr-9 text-white">
                  <svg
                    ...
                    data-prefix="fab"
                    data-icon="instagram"
                    className="svg-inline--fa fa-instagram w-5"
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512"
                  >
                ...
                <a href="http://bursapediary.com/" className="mr-9 text-white">
                  <svg
                    ...
                    className="svg-inline--fa fa-linkedin-in w-5"
                    role="img"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 448 512"
                  >
                ...
                <a href="http://bursapediary.com/" className="text-white">
                  <svg
                    aria-hidden="true"
                    focusable="false"
                    data-prefix="fab"
            ...
            <div className="">
              ...
              <p className="flex items-center justify-center md:justify-start mb-4 text-white">
                1995 Matthews, Street Bloomington, IL United States
              </p>
            </div>
          </div>
        </div>
